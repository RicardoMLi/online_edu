...
function refresh_captcha(event){
    $.get("/user/captcha/refresh/?"+Math.random(), function(result){
...
//     var password_again = $("#id_password_2").val();

//     if(password != password_again){
//          Dml.fun.showValidateError($('#jsEmailTips'),'两次输入的密码不一致');
//          return false;
//     }
...
//         success:function(data){
//             if(data.status == 'success'){
//                 $("#jsEmailToActive").text($("#id_email").val());
//                 Dml.fun.showDialog("#jsDialog");
//                 setTimeout(goto_login, 2000);
//             }
//         }
//     })
// }
