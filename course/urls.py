...
from .views import CourseListView,CourseDetailView,CheckCourseView,CourseInfoView,CourseCommentView,VideoPlayView

urlpatterns = [
	path('course_list/',CourseListView.as_view(),name='course_list'),
	path('course_detail/<int:course_id>',CourseDetailView.as_view(),name='course_detail'),
	path('check_course/',CheckCourseView.as_view(),name='check_course'),
